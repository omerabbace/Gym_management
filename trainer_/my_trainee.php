...
<table class="table table-bordered" style="color: white; font-size:large;">
  ...
  <?php
$sql = "SELECT * from assign_trainer join person on person.p_id=assign_trainer.trainee_id 
 where assign_trainer.trainer_id=$trainer_id ";
// echo $sql;
$result = mysqli_query($conn,$sql);
...
?>
  <tbody>
    <tr>
      ...
      <td> <h3 style=""><a  href="del_my_trainee.php?id=<?php echo $trainee_id ?>" style=" 
        width:140px;
        ...
        color: white;
        font-weight: bold;
        line-height: 25px;">Delete</a></h3></td>
