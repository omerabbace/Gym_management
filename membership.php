...
if(isset($_POST['submit'])){
    ...
    // echo $trainee_id;
    $sql3 = "INSERT INTO `membership`(`type_id`, `trainee_id`, `date`)
    VALUES ($type_id,$trainee_id,'$date')";
    // echo $sql3;
...
$sql = "SELECT * from membership where trainee_id=$trainee_id ";
$res = mysqli_query($conn,$sql);
if(mysqli_num_rows($res)>0){
    while($row1=mysqli_fetch_assoc($res)){
        $t_id = $row1['type_id'];
        $sql4= "SELECT * from membership_type where type_id=$t_id";
        // echo $sql4;
        ...
        if(mysqli_num_rows($res4)>0){
            while($row4=mysqli_fetch_assoc($res4)){
                $name = $row4['type'];
?>
<h1 style="color: white;">You Have <?php echo $name ?> Membership </h1>
<h3 style="margin-top: 20px;"><a  href="update_membership.php" style=" 
        width:140px;
        ...
        color: white;
        font-weight: bold;
        line-height: 25px;">Change Membership</a></h3>
<div class="row">
        <h3 style="margin-top: 20px;"><a  href="del_trainee_memb.php?id=<?php echo $trainee_id ?>" style=" 
        width:140px;
        ...
        color: white;
        font-weight: bold;
        line-height: 25px;">Delete Membership</a></h3>
        </div>
<?php
   }
}
...
?>
<h1 style="color: white;">You Dont Have Membership!</h1>;
<h2 style="color: white;">If You Want Membership choose from below</h2>;
