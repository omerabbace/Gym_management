...
$email = "";
$contact = "";
$sql = "SELECT * FROM `person`join account  WHERE p_id=$id";
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay="0.1s">Hi this is <?php echo $name," "; echo $l_name ?></span>
                                <h1 data-animation="fadeInLeft" data-delay="0.4s">Gym Trainee</h1>
